   ...
   <div class="document">
    ...
    <div class="promotors_doc">
     <form class="form-horizontal" action="" method="post">
      ...
      <div class="form-group">
       <label class=" customer-voucher_det"> Plot Area <span class="code6">:</span> </label>
       <label></label>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
       <label class=" customer-voucher_det1"> Balance Amount Before Registration <span class="code8">:</span> </label>
       <label></label>
      </div>
      <div class="form-group">
    ...
    <div class="witness">
     ...
     <div class="witness_detail">
      <p>1. RAVICHANDRAN.K - 8/20, B.S.S ROAD 1ST STREET, PALAYAKADU,THIRUPUR.</p>
      <p>2. RAVICHANDRAN.K - 8/20, B.S.S ROAD 1ST STREET, PALAYAKADU,THIRUPUR.</p>
     </div>
    </div>
   </div>
  </body>