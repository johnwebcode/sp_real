        ...
        <div class="col-md-6">
            ...
            <form class="form-horizontal" action="floor" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control " maxlength="10" type="text" value="{{old('project name')}}" name="name" placeholder="Project Name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control " maxlength="3" type="text" value="{{old('no. of plot')}}" name="number" placeholder="Ex: 1-100">
                    </div>
                </div>
