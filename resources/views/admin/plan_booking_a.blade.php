      ...
      <!-- Add Content --><form class="form-horizontal" action="spmstore" method="post">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input class="form-control "  maxlength="20" type="text" value="{{old('start_date')}}"  id="start_date" name="plan_start_date" placeholder="Start-Date">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control datepicker"  maxlength="20" type="text" value="{{old('end_date')}}" id="end_date" name="plan_end_date" placeholder="End-Date">
                    </div>
                </div>
