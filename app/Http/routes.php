...
Route::post('api/add-project','ApiController@apiAddFloor');
...
Route::get('api/find/{floor_id}/{slot_no}','ApiController@findDetailsBySlot');

Route::get('api/remove/image/{id}','ApiController@apiRemoveImage');

Route::get('api/view/details','ApiController@pagination');

Route::post('api/repark','ApiController@repark');
